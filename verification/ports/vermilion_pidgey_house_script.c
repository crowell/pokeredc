...
/* Port of VermilionPidgeyHouse_Script in scripts/VermilionPidgeyHouse.asm:
 *
...
port_vermilion_pidgey_house_script(struct cpu_register_state *state, port_u8 *memory)
{
