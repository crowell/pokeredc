...
/* Port of ViridianForestNorthGate_Script in scripts/ViridianForestNorthGate_Script.asm:
 *
...
port_viridian_forest_north_gate_script(struct cpu_register_state *state, port_u8 *memory)
{
