...
/* Port of CinnabarLabTradeRoom_Script in scripts/CinnabarLabTradeRoom_Script.asm:
 *
...
port_cinnabar_lab_trade_room_script(struct cpu_register_state *state, port_u8 *memory)
{
