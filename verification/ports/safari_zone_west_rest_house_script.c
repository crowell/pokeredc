...
/* Port of SafariZoneWestRestHouse_Script in scripts/SafariZoneWestRestHouse.asm:
 *
...
port_safari_zone_west_rest_house_script(struct cpu_register_state *state, port_u8 *memory)
{
