...
/* Port of Route12Gate2F_Script in scripts/Route12Gate2F.asm:
 *
 *   jp DisableAutoTextBoxDrawing
 */

void port_disable_auto_text_box_drawing(struct auto_text_box_state *);

#define W_AUTO_TEXT_BOX_DRAWING_CONTROL 0xcf0cu
#define W_DO_NOT_WAIT_FOR_BUTTON_PRESS  0xcc3cu

__attribute__((noinline, used)) void
port_route12_gate2_f_script(struct cpu_register_state *state, port_u8 *memory)
{
	...
	port_disable_auto_text_box_drawing(&text_box);
