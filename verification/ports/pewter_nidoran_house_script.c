...
/* Port of PewterNidoranHouse_Script in scripts/PewterNidoranHouse_Script.asm:
 *
...
port_pewter_nidoran_house_script(struct cpu_register_state *state, port_u8 *memory)
{
