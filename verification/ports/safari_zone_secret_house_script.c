...
/* Port of SafariZoneSecretHouse_Script in scripts/SafariZoneSecretHouse_Script.asm:
 *
...
port_safari_zone_secret_house_script(struct cpu_register_state *state, port_u8 *memory)
{
