...
/* Port of CeladonMansionRoof_Script in scripts/CeladonMansionRoof_Script.asm:
 *
...
port_celadon_mansion_roof_script(struct cpu_register_state *state, port_u8 *memory)
{
