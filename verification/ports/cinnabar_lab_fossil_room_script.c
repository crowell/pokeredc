...
/* Port of CinnabarLabFossilRoom_Script in scripts/CinnabarLabFossilRoom_Script.asm:
 *
...
port_cinnabar_lab_fossil_room_script(struct cpu_register_state *state, port_u8 *memory)
{
