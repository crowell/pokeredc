...
/* Port of VermilionOldRodHouse_Script in scripts/VermilionOldRodHouse_Script.asm:
 *
...
port_vermilion_old_rod_house_script(struct cpu_register_state *state, port_u8 *memory)
{
