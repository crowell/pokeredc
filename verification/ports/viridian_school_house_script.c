...
/* Port of ViridianSchoolHouse_Script in scripts/ViridianSchoolHouse_Script.asm:
 *
...
port_viridian_school_house_script(struct cpu_register_state *state, port_u8 *memory)
{
