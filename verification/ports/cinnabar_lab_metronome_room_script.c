...
/* Port of CinnabarLabMetronomeRoom_Script in scripts/CinnabarLabMetronomeRoom_Script.asm:
 *
...
port_cinnabar_lab_metronome_room_script(struct cpu_register_state *state, port_u8 *memory)
{
