...
/* Port of DiglettsCaveRoute2Script in DiglettsCaveRoute2Script_script.asm equivalent:
 *   ld a, 0x0d
 *   ld [wLastMap], a
...
port_digletts_cave_route2_script(struct cpu_register_state *state, port_u8 *memory)
{
