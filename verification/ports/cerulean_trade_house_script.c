...
/* Port of CeruleanTradeHouse_Script in scripts/CeruleanTradeHouse_Script.asm:
 *
...
port_cerulean_trade_house_script(struct cpu_register_state *state, port_u8 *memory)
{
