...
/* Port of FuchsiaGoodRodHouse_Script in scripts/FuchsiaGoodRodHouse_Script.asm:
 *
...
port_fuchsia_good_rod_house_script(struct cpu_register_state *state, port_u8 *memory)
{
