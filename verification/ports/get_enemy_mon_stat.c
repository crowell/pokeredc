...
struct get_enemy_mon_stat_state {
	struct cpu_register_state registers;
	port_u8 link_state;
};

/* Port of GetEnemyMonStat through the link-state branch decision. */
__attribute__((noinline, used)) void
port_get_enemy_mon_stat(struct get_enemy_mon_stat_state *state)
{
