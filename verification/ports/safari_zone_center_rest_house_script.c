...
/* Port of SafariZoneCenterRestHouse_Script in scripts/SafariZoneCenterRestHouse_Script.asm:
 *
...
port_safari_zone_center_rest_house_script(struct cpu_register_state *state, port_u8 *memory)
{
