...
/* Port of SafariZoneNorthRestHouse_Script in scripts/SafariZoneNorthRestHouse.asm:
 *
...
port_safari_zone_north_rest_house_script(struct cpu_register_state *state, port_u8 *memory)
{
