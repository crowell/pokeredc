...
#define TRAINER_CHAR_TEXT 0x1a58u

void port_place_command_character(struct place_command_character_state *,
	port_u8 *);

/* Port of TrainerChar in home/text.asm. */
__attribute__((noinline, used)) void
port_trainer_char(struct trainer_char_state *state, port_u8 *memory)
{
	...
	command.registers.d = (port_u8)(TRAINER_CHAR_TEXT >> 8);
	command.registers.e = (port_u8)TRAINER_CHAR_TEXT;
