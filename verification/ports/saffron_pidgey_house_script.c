...
/* Port of SaffronPidgeyHouse_Script in scripts/SaffronPidgeyHouse_Script.asm:
 *
...
port_saffron_pidgey_house_script(struct cpu_register_state *state, port_u8 *memory)
{
