...
#define CLEAR_CURSOR 0xc4a5u
#define TEXT_CURSOR 0xc4b9u
#define TILE_DOWN_ARROW 0xeeu
#define CLEAR_ROWS 4u
...
/* Port of Paragraph in home/text.asm.  The saved DE is the dispatcher's
 * source pointer; the handler's final jump to NextChar is its continuation
 * boundary. */
__attribute__((noinline, used)) void
port_paragraph(struct paragraph_state *state, port_u8 *memory)
{
