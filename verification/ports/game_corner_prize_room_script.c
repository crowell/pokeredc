...
/* Port of GameCornerPrizeRoom_Script in scripts/GameCornerPrizeRoom_Script.asm:
 *
...
port_game_corner_prize_room_script(struct cpu_register_state *state, port_u8 *memory)
{
