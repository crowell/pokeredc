...
/* Port of PewterSpeechHouse_Script in scripts/PewterSpeechHouse_Script.asm:
 *
...
port_pewter_speech_house_script(struct cpu_register_state *state, port_u8 *memory)
{
