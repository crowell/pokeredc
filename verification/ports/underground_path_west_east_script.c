...
/* Port of UndergroundPathWestEast_Script in scripts/UndergroundPathWestEast_Script.asm:
 *
...
port_underground_path_west_east_script(struct cpu_register_state *state, port_u8 *memory)
{
