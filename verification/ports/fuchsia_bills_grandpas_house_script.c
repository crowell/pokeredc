...
/* Port of FuchsiaBillsGrandpasHouse_Script in scripts/FuchsiaBillsGrandpasHouse.asm:
 *
...
port_fuchsia_bills_grandpas_house_script(struct cpu_register_state *state, port_u8 *memory)
{
