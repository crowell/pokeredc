...
/* Port of ViridianNicknameHouse_Script in scripts/ViridianNicknameHouse_Script.asm:
 *
...
port_viridian_nickname_house_script(struct cpu_register_state *state, port_u8 *memory)
{
