...
struct load_enemy_mon_data_state {
	struct cpu_register_state registers;
	port_u8 link_state;
};

/* Port of LoadEnemyMonData through the link-battle branch. */
__attribute__((noinline, used)) void
port_load_enemy_mon_data(struct load_enemy_mon_data_state *state)
{
