...
/* Port of CeruleanTrashedHouse_Script in scripts/CeruleanTrashedHouse.asm:
 *
...
port_cerulean_trashed_house_script(struct cpu_register_state *state, port_u8 *memory)
{
