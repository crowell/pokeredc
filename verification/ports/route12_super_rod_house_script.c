...
/* Port of Route12SuperRodHouse_Script in scripts/Route12SuperRodHouse_Script.asm:
 *
...
port_route12_super_rod_house_script(struct cpu_register_state *state, port_u8 *memory)
{
