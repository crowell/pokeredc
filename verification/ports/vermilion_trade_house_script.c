...
/* Port of VermilionTradeHouse_Script in scripts/VermilionTradeHouse_Script.asm:
 *
...
port_vermilion_trade_house_script(struct cpu_register_state *state, port_u8 *memory)
{
