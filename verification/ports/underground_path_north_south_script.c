...
/* Port of UndergroundPathNorthSouth_Script in scripts/UndergroundPathNorthSouth_Script.asm:
 *
...
port_underground_path_north_south_script(struct cpu_register_state *state, port_u8 *memory)
{
