...
/* Port of UndergroundPathRoute8Script in UndergroundPathRoute8Script_script.asm equivalent:
 *   ld a, 0x13
 *   ld [wLastMap], a
...
port_underground_path_route8_script(struct cpu_register_state *state, port_u8 *memory)
{
