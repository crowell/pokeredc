...
/* Port of ViridianForestSouthGate_Script in scripts/ViridianForestSouthGate_Script.asm:
 *
...
port_viridian_forest_south_gate_script(struct cpu_register_state *state, port_u8 *memory)
{
