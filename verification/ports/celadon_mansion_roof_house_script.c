...
/* Port of CeladonMansionRoofHouse_Script in scripts/CeladonMansionRoofHouse_Script.asm:
 *
...
port_celadon_mansion_roof_house_script(struct cpu_register_state *state, port_u8 *memory)
{
