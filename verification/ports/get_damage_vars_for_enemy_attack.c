...
struct get_damage_vars_enemy_state {
	struct cpu_register_state registers;
	port_u8 move_power;
};

/* Port of GetDamageVarsForEnemyAttack through the zero-power return. */
__attribute__((noinline, used)) void
port_get_damage_vars_for_enemy_attack(struct get_damage_vars_enemy_state *state)
{
