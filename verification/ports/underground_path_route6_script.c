...
/* Port of UndergroundPathRoute6Script in UndergroundPathRoute6Script_script.asm equivalent:
 *   ld a, 0x11
 *   ld [wLastMap], a
...
port_underground_path_route6_script(struct cpu_register_state *state, port_u8 *memory)
{
