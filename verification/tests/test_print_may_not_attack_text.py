...
def test_print_may_not_attack_text_pathwise_equivalence():
 v=symbolic_registers('may_not_attack');assert_pathwise_equivalent(_assembly(v),_native(v),REGISTERS)
