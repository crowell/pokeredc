...
EXPECTED=bytes.fromhex('21647bc3493c')
...
def test_print_didnt_affect_text_pathwise_equivalence():
 v=inputs('print_didnt_affect_text');assert_pathwise_equivalent(assembly(v),native(v),(*REGISTERS,'call','marker'))
