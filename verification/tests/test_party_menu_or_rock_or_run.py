...
def _assembly(values: dict[str, claripy.ast.BV]) -> list[Endpoint]:
    location = symbol_location(SYMBOLS, "PartyMenuOrRockOrRun")
...
def _native(values: dict[str, claripy.ast.BV]) -> list[Endpoint]:
    ...
    function = project.loader.find_symbol("port_party_menu_or_rock_or_run")
...
def test_party_menu_or_rock_or_run_entry_pathwise_equivalence() -> None:
    values = symbolic_registers("party_menu_or_rock_or_run")
