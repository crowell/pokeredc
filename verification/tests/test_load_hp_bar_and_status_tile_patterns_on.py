...
DONE = 0xEFFF
MARKER = 0x1234
EXPECTED_BODY = bytes.fromhex("11a05e212096011e04c34818")


def _assembly(values: dict[str, claripy.ast.BV]) -> list[Endpoint]:
    location = symbol_location(SYMBOLS, "LoadHpBarAndStatusTilePatterns.on")
...
def test_load_hp_bar_and_status_tile_patterns_on_pathwise_equivalence() -> None:
    values = _inputs("load_hp_bar_and_status_tile_patterns_on")
