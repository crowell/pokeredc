...
def _assembly(values: dict[str, claripy.ast.BV]) -> list[Endpoint]:
    location = symbol_location(SYMBOLS, "BagWasSelected")
...
def _native(values: dict[str, claripy.ast.BV]) -> list[Endpoint]:
    ...
    function = project.loader.find_symbol("port_bag_was_selected")
...
def test_bag_was_selected_entry_pathwise_equivalence() -> None:
    values = symbolic_registers("bag_was_selected")
    values["battle_type"] = claripy.BVS("bag_was_selected_battle_type", 8)
