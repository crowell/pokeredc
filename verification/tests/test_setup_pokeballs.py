...
def _native(values: dict[str, claripy.ast.BV]) -> list[Endpoint]:
    ...
    function = project.loader.find_symbol("port_setup_pokeballs")
...
def test_setup_pokeballs_pathwise_equivalence() -> None:
    values = symbolic_registers("setup_pokeballs")
