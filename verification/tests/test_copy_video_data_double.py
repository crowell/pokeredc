...
from verification.tests.test_copy_video_data import StoreRomb, XorA
...
EXPECTED = bytes.fromhex(
    "f0baf5afe0baf0b8e08b78e0b8ea00207be0cc7ae0cd7de0ce7ce0cf"
    "79fe083010e0cbcdaf20f08be0b8ea0020f1e0bac93e08e0cbcdaf2079"
    "d6084f18de"
)
...
def test_copy_video_data_double_all_counts_pathwise_equivalence() -> None:
    for quotient in range(32):
        values = _inputs(f"copy_video_data_double_{quotient}", quotient)
