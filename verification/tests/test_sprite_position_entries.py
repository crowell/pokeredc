...
PORTS = (
    ("GetSpritePosition1", "_GetSpritePosition1", "port_get_sprite_position1", True),
    ("GetSpritePosition2", "_GetSpritePosition2", "port_get_sprite_position2", True),
    ("SetSpritePosition1", "_SetSpritePosition1", "port_set_sprite_position1", True),
    ("SetSpritePosition2", "_SetSpritePosition2", "port_set_sprite_position2", False),
)
...
def _assembly(symbol: str, inputs: dict[str, claripy.ast.BV]) -> Endpoint:
    ...
    tail = symbol_location(SYMBOLS, "SpritePositionBankswitch").address
...
def test_sprite_position_entry_symbolic_equivalence(
...
def test_sprite_position_entry_exact_linked_body(
