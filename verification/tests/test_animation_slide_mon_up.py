...
def _assembly(values: dict[str, claripy.ast.BV]) -> list[Endpoint]:
    location = symbol_location(SYMBOLS, "_AnimationSlideMonUp")
    continuation = symbol_location(SYMBOLS, "CopyData")
...
def _native(values: dict[str, claripy.ast.BV]) -> list[Endpoint]:
    ...
    function = project.loader.find_symbol("port_animation_slide_mon_up")
...
def test_animation_slide_mon_up_entry_pathwise_equivalence() -> None:
    values = symbolic_registers("animation_slide_mon_up")
