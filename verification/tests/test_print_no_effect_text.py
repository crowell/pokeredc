...
EXPECTED=bytes.fromhex('21497bc3493c')
...
def test_print_no_effect_text_pathwise_equivalence():
 v=inputs('print_no_effect_text');assert_pathwise_equivalent(assembly(v),native(v),(*REGISTERS,'call','marker'))
