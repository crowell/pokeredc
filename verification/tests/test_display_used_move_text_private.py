...
EXPECTED=bytes.fromhex('21fb5ac3493c')
...
def test_display_used_move_text_private_pathwise_equivalence():
 v=inputs('display_used_move_text_private');assert_pathwise_equivalent(assembly(v),native(v),(*REGISTERS,'call','marker'))
