...
def _native(values: dict[str, claripy.ast.BV]) -> list[Endpoint]:
    ...
    function = project.loader.find_symbol("port_draw_huds_and_hp_bars")
...
def test_draw_huds_and_hp_bars_pathwise_equivalence() -> None:
    values = symbolic_registers("draw_huds_and_hp_bars")
