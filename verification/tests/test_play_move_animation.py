...
def _assembly(values: dict[str, claripy.ast.BV]) -> list[Endpoint]:
    location = symbol_location(SYMBOLS, "PlayMoveAnimation")
...
def _native(values: dict[str, claripy.ast.BV]) -> list[Endpoint]:
    ...
    function = project.loader.find_symbol("port_play_move_animation")
...
def test_play_move_animation_pathwise_equivalence() -> None:
    values = symbolic_registers("play_move_animation")
