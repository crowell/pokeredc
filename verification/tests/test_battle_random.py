...
def _assembly(values: dict[str, claripy.ast.BV]) -> list[Endpoint]:
    location = symbol_location(SYMBOLS, "BattleRandom")
...
def test_battle_random_link_pathwise_equivalence() -> None:
    values = symbolic_registers("battle_random")
    values["link_state"] = claripy.BVS("battle_random_link_state", 8)
