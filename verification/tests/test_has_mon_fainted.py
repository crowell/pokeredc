...
def _assembly(values: dict[str, claripy.ast.BV]) -> list[Endpoint]:
    location = symbol_location(SYMBOLS, "HasMonFainted")
...
def test_has_mon_fainted_setup_pathwise_equivalence() -> None:
    values = symbolic_registers("has_mon_fainted")
    values["which_pokemon"] = claripy.BVS("has_mon_fainted_which_pokemon", 8)
