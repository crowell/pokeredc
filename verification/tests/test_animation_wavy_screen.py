...
def _assembly(values: dict[str, claripy.ast.BV]) -> list[Endpoint]:
    location = symbol_location(SYMBOLS, "AnimationWavyScreen")
    continuation = symbol_location(SYMBOLS, "BattleAnimCopyTileMapToVRAM")
...
def _native(values: dict[str, claripy.ast.BV]) -> list[Endpoint]:
    ...
    function = project.loader.find_symbol("port_animation_wavy_screen")
...
def test_animation_wavy_screen_entry_pathwise_equivalence() -> None:
    values = symbolic_registers("animation_wavy_screen")
