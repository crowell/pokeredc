...
def _assembly(values: dict[str, claripy.ast.BV]) -> list[Endpoint]:
    ...
    project.hook(location.address, Boundary(), length=3)
...
def _native(values: dict[str, claripy.ast.BV]) -> list[Endpoint]:
    ...
    function = project.loader.find_symbol("port_apply_attack_to_enemy_pokemon_done")
...
def test_apply_attack_to_enemy_pokemon_done_pathwise_equivalence() -> None:
    values = symbolic_registers("apply_attack_to_enemy_pokemon_done")
