...
def _assembly(values: dict[str, claripy.ast.BV]) -> list[Endpoint]:
    ...
    state = project.factory.blank_state(addr=delay3.address)
...
def _native(values: dict[str, claripy.ast.BV]) -> list[Endpoint]:
    ...
    function = project.loader.find_symbol("port_delay3")
...
def test_delay3_pathwise_equivalence() -> None:
    values = symbolic_registers("delay3")
